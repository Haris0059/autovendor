  ...
  return (
    <div className="flex flex-col gap-4 px-4 py-4 md:gap-6 md:py-6 lg:px-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        />
        <StatCard
          title="Uspješnost sync-a"
          value={`${successRate}%`}
          description="Zadnjih 50 zapisa"
